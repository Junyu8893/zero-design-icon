...
export default IconBuilder('android', (data: IconSvgRenderData) => (
  <svg
    width={data.size}
    height={data.size}
    fill="none"
  ...
  >
    ...
    <path
      ...
      stroke-linejoin={data.strokeLineJoin}
      stroke-width={data.strokeWidth}
      d="m14 20-4-7m23 7 4-7"
    />
    <circle cx="15" cy="29" r="2" fill={data.colorDesc[2]} />
    <circle cx="33" cy="29" r="2" fill={data.colorDesc[2]} />
  </svg>
));
